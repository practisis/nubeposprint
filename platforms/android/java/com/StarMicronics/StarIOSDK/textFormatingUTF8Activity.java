...
public class textFormatingUTF8Activity extends Activity {
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.textformatingutf8);
	...
	public void PrintText(View view) {
		...
		RadioButton radio_Ambiguoue_Half_size = (RadioButton) findViewById(R.id.radio_Ambiguoue_Half_size);
		boolean ambiguous_character_Half_size = true;
		if (radio_Ambiguoue_Half_size.isChecked() == true) {
			ambiguous_character_Half_size = true;
		} else {
			ambiguous_character_Half_size = false;
		}
		...
		PrinterFunctions.PrintTextUTF8(this, portName, portSettings, ambiguous_character_Half_size, slashedZero, underline, invertColor, emphasized, upperline, upsideDown, heightExpansion, widthExpansion, leftMargin, alignment, textToPrint, "UTF-8");
	}
	...
	public void Help(View view) {
		...
		String helpString =
				"<UnderlineTitle>Specify Ambiguous Character Settings(Half-size character priority)</UnderlineTitle><br/><br/>\n" +
				"<Code>ASCII:</Code> <CodeDef>ESC GS ) U  <StandardItalic>pL pH fn n</StandardItalic></CodeDef><br/>\n" +
				"<Code>Hex:</Code> <CodeDef>1B 1D 29 55 <StandardItalic>pL pH fn n</StandardItalic></CodeDef><br/><br/>\n" +
				"<rightMov>pL = 2 ,pH = 0,fn = 64</rightMov><br/><br/>\n" +
